...
class Main:
    def __init__(self):
        ...
        self.hall_west_door = Door({Dh.WEST: self.west_room, Dh.EAST: self.hall}, isopen=True, islocked=False)
        self.wr_west_door = Door({Dh.WEST: self.trophy_room, Dh.EAST: self.west_room}, isopen=True, islocked=False)
        self.tr_north_door = Door({Dh.NORTH: self.ns_passageway, Dh.SOUTH: self.trophy_room}, isopen=True, islocked=False)
        self.ns_north_door = Door({Dh.NORTH: self.staff_room, Dh.SOUTH: self.ns_passageway}, isopen=True, islocked=False)
        self.sr_east_door = Door({Dh.EAST: self.library, Dh.WEST: self.staff_room}, isopen=True, islocked=False)
        self.lb_south_door = Door({Dh.SOUTH: self.library_entrance, Dh.NORTH: self.library}, isopen=True, islocked=False)
        self.le_south = Door({Dh.SOUTH: self.hall, Dh.NORTH: self.library_entrance}, isopen=True, islocked=False)
        self.hall_east_door = Door({Dh.EAST: self.east_room, Dh.WEST: self.hall}, isopen=True, islocked=False)
        self.er_east_door = Door({Dh.EAST: self.throne_entrance, Dh.WEST: self.east_room}, isopen=True, islocked=False)
        self.throne_door = Door({Dh.NORTH: self.throne_room, Dh.SOUTH: self.throne_entrance}, isopen=True, islocked=False)
