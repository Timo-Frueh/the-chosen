...
class Main:
    def __init__(self):
        ...
        self.scholar.add_conversation(self.scholar_con_f)
        ...
        self.hag.add_conversation(self.hag_con_f)
        ...
        self.stranger.add_conversation(self.stranger_con_f)
        ...
        self.warrioress.add_conversation(self.warrioress_con_f)
        ...
        self.mandrak.add_conversation(self.mandrak_con_f)
        ...
        self.demon_king.add_conversation(self.demon_king_con_f)
